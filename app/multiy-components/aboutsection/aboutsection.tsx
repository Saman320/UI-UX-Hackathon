      ...
      <div className='flex flex-col justify-center items-center font-sans font-semibold my-6'>
        ...
        <div className='flex justify-center items-center flex-col  md:flex-row gap-10 md:gap-20 lg:gap-48'>
          ...
          <div className='bg-[#ffbeff] rounded-full bg-cover'>
            <Image src="/images/about-image.png" alt="about" height={350} width={350} />
          </div>
        </div>
        ...
        <div className='px-5 my-20'>
          <Image src={"/images/videocard.png"} height={600} width={700} alt="video" />
        </div>
        ...
        <div>
          ...
          <div className='flex justify-center items-center flex-col md:flex-row lg:flex-row gap-6 '>
            ...
            {/* card 1 */}
            <div className='flex justify-center items-center flex-col my-5'><Image src={"/images/media.png"} height={230} width={240} alt='team' /><h3 className='mt-5'>Username</h3><p className='my-3'>Profession</p>
            ...
            {/* card 2 */}
            <div className='flex justify-center items-center flex-col my-5'><Image src={"/images/media2.png"} height={250} width={250} alt='team' /><h3 className='mt-5'>Username</h3><p className='my-3'>Profession</p>
              <div className="flex gap-6">
                <a
                  href="https://www.facebook.com"
                  target="_blank"
            ...
            {/* card 3 */}
            <div className='flex justify-center items-center flex-col my-5'><Image src={"/images/media3.png"} height={250} width={250} alt='team' /><h3 className='mt-5'>Username</h3><p className='my-3'>Profession</p>
              <div className="flex gap-6">
                <a
                  href="https://www.facebook.com"
                  target="_blank"
        ...
        <div className='flex justify-center items-center flex-col md:flex-row lg:flex-row text-white'>
          ...
          <div className=''>
            <Image src="/images/card8.png" alt="about" height={350} width={350} />
          </div>
        </div>
        </div>
